...
dengan $M_{ij}$ adalah minor dari matriks $A$ dan $M_{ij} = \det A_{ij}$.
...
# Dekomposisi Matrix — QR Gram-Schmidt
...
$$v_2 = \begin{bmatrix}-\frac{17}{22}\\4\\-\frac{9}{22}\\\frac{9}{22}\end{bmatrix}, \quad q_2 = \frac{v_2}{\|v_2\|}$$
